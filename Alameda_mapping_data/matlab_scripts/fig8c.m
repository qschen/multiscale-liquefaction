...
name_nodes=fullfile('..','nodes.txt');
name1=fullfile('..','fig8c','scale01.mat');
name2=fullfile('..','fig8c','scale02.mat');
name3=fullfile('..','fig8c','BIG.mat');
name4=fullfile('..','fig8c','scale01V.mat');
name5=fullfile('..','fig8c','scale02V.big.mat');
name6=fullfile('..','fig8c','BIGV.mat');
