...
name1=fullfile('..','fig8e','scale01.mat');
name2=fullfile('..','fig8e','scale02.mat');
name3=fullfile('..','fig8e','BIG.mat');
name4=fullfile('..','fig8e','scale01V.mat');
name5=fullfile('..','fig8e','scale02V.big.mat');
name6=fullfile('..','fig8e','BIGV.mat');
