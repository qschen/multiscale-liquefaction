...
name1=fullfile('..','fig8b','scale01.mat');
name2=fullfile('..','fig8b','scale02.mat');
name3=fullfile('..','fig8b','BIG.mat');
name4=fullfile('..','fig8b','scale01V.mat');
name5=fullfile('..','fig8b','scale02V.big.mat');
name6=fullfile('..','fig8b','BIGV.mat');
