...
name1=fullfile('..','fig8d','scale01.mat');
name2=fullfile('..','fig8d','scale02.mat');
name3=fullfile('..','fig8d','BIG.mat');
name4=fullfile('..','fig8d','scale01V.mat');
name5=fullfile('..','fig8d','scale02V.big.mat');
name6=fullfile('..','fig8d','BIGV.mat');
